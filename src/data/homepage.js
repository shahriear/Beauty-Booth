...
export const heroBanners = [
  { url: '/images/banner-Img/banner-1.webp', category: 'banner' },
  { url: '/images/banner-Img/banner-2.webp', category: 'banner' },
  { url: '/images/banner-Img/banner-3.webp', category: 'banner' },
  { url: '/images/banner-Img/banner-4.webp', category: 'banner' },
];

export const trendingBanners = [
  { url: '/images/TRENDING-img/trendingIMG-1.webp', category: 'trending' },
  { url: '/images/TRENDING-img/trendingIMG-2.webp', category: 'trending' },
  { url: '/images/TRENDING-img/trendingIMG-3.webp', category: 'trending' },
  { url: '/images/TRENDING-img/trendingIMG-4.webp', category: 'trending' },
];

export const exclusiveAccessoriesBanners = [
  {
    url: '/images/ExclusiveAccessories/ExclusiveAccessories-1.webp',
    category: 'exclusive-accessories',
  },
  {
    url: '/images/ExclusiveAccessories/ExclusiveAccessories-2.webp',
    category: 'exclusive-accessories',
  },
  {
    url: '/images/ExclusiveAccessories/ExclusiveAccessories-3.webp',
    category: 'exclusive-accessories',
  },
  {
    url: '/images/ExclusiveAccessories/ExclusiveAccessories-4.webp',
    category: 'exclusive-accessories',
  },
  {
    url: '/images/ExclusiveAccessories/ExclusiveAccessories-5.webp',
    category: 'exclusive-accessories',
  },
];
...
export const topCategories = [
  {
    name: 'Make up',
    slug: 'makeup',
    img: '/images/Top-Categories/TopCategories-1.webp',
  },
  {
    name: 'Skin Care',
    slug: 'skin-care',
    img: '/images/Top-Categories/TopCategories-2.webp',
  },
  {
    name: 'Hair Care',
    slug: 'hair-care',
    img: '/images/Top-Categories/TopCategories-3.webp',
  },
  {
    name: 'Bath & Body Care',
    slug: 'bath-body-care',
  ...
  },
  {
    name: 'Accessories',
    slug: 'accessories',
    img: '/images/Top-Categories/TopCategories-6.webp',
  },
];
...
export const freeDeliveryOffers = [
  {
    ...
    logo: '/images/Free-Delivery/delivery-logo-1.png',
    category: 'free-delivery-available',
  },
  {
    id: 2,
    discount: 'Up to 15% Off',
...
export const flatSalesOffers = [
  {
    ...
    category: 'flat-sales-percentage',
  },
  {
    id: 2,
    discount: 'Flat 16% Off',
...
export const featuredVideosMeta = [
  {
    ...
    price: 25,
    oldPrice: 30,
    productIds: ['skin-care-1', 'skin-care-2', 'skin-care-3', 'skin-care-4'],
  },
  {
    ...
    price: 18,
    oldPrice: 22,
    productIds: ['skin-care-5', 'skin-care-6', 'skin-care-7', 'skin-care-8'],
  },
  {
    ...
    price: 12,
    oldPrice: 15,
    productIds: ['skin-care-9', 'skin-care-10', 'skin-care-11', 'skin-care-12'],
  },
  {
